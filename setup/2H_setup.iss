...
AppVerName=Dichotic Harmony Project. Version 3.06 from September, 2011.
...
MinVersion=4,4
ExtraDiskSpaceRequired=19000000
...
Root: HKCR; Subkey: "Dichotic Harmony Accords Generator\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\bin\2hag_gw.exe"" ""%1"""

 Root: HKCR; Subkey: "Dichotic Harmony Accords Generator\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\bin\2hag_gw.exe,0"
...
Source: "..\bin\accords\1H_2H_LIB\*";      DestDir: "{app}\bin\accords\1H_2H_LIB"
...
Source: "..\midi\1H_2H_LIB\*";             DestDir: "{app}\midi\1H_2H_LIB"
...
Name: "{group}\Dichotic Harmony Accords Generator"; Filename: "{app}\bin\2hag_gw.exe"; WorkingDir: "{app}\bin";
...
Name: "{userdesktop}\Dichotic Harmony Accords Generator"; Filename: "{app}\bin\2hag_gw.exe"; WorkingDir: "{app}\bin";

[Run]

; --- по умолчанию запускаем это
Filename: "{app}\bin\2hag_gw.exe";  WorkingDir: "{app}\bin"; Description: "Запустить Dichotic Harmony Accords Generator"; Flags: postinstall nowait skipifsilent;
